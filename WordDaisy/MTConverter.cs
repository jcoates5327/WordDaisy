...
namespace ConvertEquations {
    ...
    class ConvertEquation {
        ...
        protected bool SetTranslator() {
            ...
            Int32 stat = MathTypeSDK.Instance.MTXFormSetTranslatorMgn((ushort)MTXFormSetTranslator.mtxfmTRANSL_INC_NONE,
                m_eo.strOutTrans);
    ...
    class Program {
        ...
        public void FileToLocal(string inFile, string outFile, ConvertEquation ce) {
            // WMF file to MML text file
            ce.Convert(new EquationInputFileWMF(inFile),
                        new EquationOutputFileText(outFile, "MathML2 (m namespace).tdl"));
